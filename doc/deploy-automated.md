...
| `AZURE_CLIENT_ID`            | Client Identifier of the Azure application used to deploy (Azure Portal → Application's overview → Application (Client) ID)        | `abcdef12-3456-7890-abcd-ef1234567890`        | Yes      |
